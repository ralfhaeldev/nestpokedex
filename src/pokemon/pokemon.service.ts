import { BadRequestException, Injectable, InternalServerErrorException, NotFoundException, Module } from '@nestjs/common';
...
export class PokemonService {
  ...
  private handlerException(error: any) {
    if (error.code == 11000)
      throw new BadRequestException(`duplicación de registro ${JSON.stringify(error.keyValue)}`);
